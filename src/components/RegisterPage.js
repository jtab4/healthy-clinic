        ...
        <div className="flex flex-col h-screen">
            ...
            <div className="flex-grow flex items-center justify-center bg-gray-700">
                <div className="w-full max-w-md p-8 space-y-8 bg-gray-900 rounded shadow-md">
                    <h2 className="font-sans text-2xl font-bold text-center text-gray-300">Utwórz konto</h2>
                    <form className="mt-8 space-y-6">
                        <div className="rounded-md shadow-sm space-y-4">
                            ...
                            <div>
                                <label htmlFor="repeated-password" className="block text-sm font-medium text-gray-300">
                                    Powtórz hasło
                                </label>
                                <input
